...
7. Add Azure functions as your api
   ...
   * Use the extension to create a new functions app. When prompted:
   ...
   ```bash
   cd ./api
   npm i azure-functions-core-tools -D
   ```
...
1. Azure functions app tooling
   ...
   ```bash
   npm i npm-run-all -D  # <- make sure current working directory is at the root of the repo
   cd ./api
...
2. Azure static web app emulator
   ...
   *(if you are creating your own library, review `routes` configuration block of the files you've copied and adjust your demo app's specific requirements)*
...
2. Add distributed build cache
   ...
   Following the instructions here: https://nx.app/docs/add-nx-cloud-to-workspace#adding-nx-cloud-to-an-existing-workspace
...
2. Add dev guidance
   ...
   * Add a [README.md](README.md) with an overview and development guide. See README.md from this repo
